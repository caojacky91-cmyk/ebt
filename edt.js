...
/*Array of
  ["<key>", <rank>, [
    ...
    ["<decomp>", [
     ...
     "Really, (2) ?", "Have you ever fantasized (2) while you were awake ?", "Have you ever dreamed (2) before ?","ref dream"]]]],["dream", 3, [["*", [
...
["name", 15, [["*", [ "I am not interested in names.", "I've told you before, I don't care about names -- please continue."]]]],["deutsch", 0, [["*", ["ref xforeign", "I told you before, I don't understand German."]]]],
["francais", 0, [["*", ["ref xforeign","I told you before, I don't understand French."]]]],["italiano", 0, [["*", ["ref xforeign", "I told you before, I don't understand Italian."]]]],
["espanol", 0, [["*", ["ref xforeign","I told you before, I don't understand Spanish."]]]],["xforeign", -1, [["*", ["I speak only English.","I only can speak English.","I know only English."]]]],
["hello|hi", 0, [["*", ["How do you do.  Please state your problem.","Hi.  What seems to be your problem ?",
     //addition(no original)
     ...
     "You don't think I am a computer program, do you ?"]]]],["am", 0, [["* am i *", [
     "Do you believe you are (2) ?", "Would you want to be (2) ?","Do you wish I would tell you you are (2) ?",
     "What would it mean if you were (2) ?","ref what"]],["* i am *", ["ref i"]],["*", ["Why do you say 'am' ?","I don't understand that."]]]],["are", 0, [["* are you *", [
     "Why are you interested in whether I am (2) or not ?","Would you prefer if I weren't (2) ?","Perhaps I am (2) in your fantasies.","Do you sometimes think I am (2) ?","ref what","Would it matter to you ?","What if I were (2) ?"]],
 ["* you are *", ["ref you"]],["* are *", ["Did you think they might not be (2) ?","Would you like it if they were not (2) ?","What if they were not (2) ?",
...
here: cleanings for multiple bots talking to each other*/var elzPstTrsfs=[	/ old old/g," old",/\bthey were( not)? me\b/g,"it was$1 me",/\bthey are( not)? me\b/g,"it is$1 me",/Are they( always)? me\b/,"it is$1 me",
