/*eb.js v.1.1(mod) - ELIZA JS library(N.Landsteiner 2005)
  ...
  usage: var eliza = new EB();
         ...
         var reply = eliza.tf(<inputstr>);
         if (eliza.q) {
             // last user input was a quit phrase
         }

         // method `tf()' returns a final phrase in case of a quit phrase
